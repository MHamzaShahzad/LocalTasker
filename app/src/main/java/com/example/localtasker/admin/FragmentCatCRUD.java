            ...
            try {
                ...
                if (oldTaskCat != null) {
                    if (oldTaskCat.getCategoryImageUrl() != null && !oldTaskCat.getCategoryImageUrl().equals("") && !oldTaskCat.getCategoryImageUrl().equals("null"))
                        Picasso.get().load(oldTaskCat.getCategoryImageUrl()).placeholder(R.drawable.ic_launcher_background).error(R.drawable.ic_launcher_background).centerInside().fit().into(catImageView);
